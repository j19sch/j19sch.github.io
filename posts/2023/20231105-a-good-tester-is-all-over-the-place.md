...
Post I kind of want to link to:
- [agile tester or quality engineer](link://slug/agile-tester-or-quality-engineer-whos-to-say)


---

Over the past year, I've been thinking about how testing-related roles are still an unsolved problem in software development. We keep trying different permuations: shifting left and shifting right, being closer to the programmers while not too far from other testers, doing less testing ourselves so we can support others more, etc.
...
```
This post has become quite a long reflection on testers and testing-related roles, such as quality engineers. And each section could have been its own post, each as long as this one, with more details and nuance.

I guess it just proves the point of my conclusion: testing-related roles are still an unsolved problem in software development. In the mean time, anyone in such a role will have to "be all over the place", in a good way.
...
So that's quite a wide range of activities, even when I leave out activities related to being a member of the development team (e.g. retropsectives) and to being an employee (e.g. all-hands meetings). Luckily, testers are not the only ones doing testing. Unluckily, this creates some challenges.
...
A good tester is all over the place. Roles and processes provide structure, a starting point. You can't limit yourself to only working inside those structures, though. You also need to be comfortable working oustide (and around) them. Testing happens across roles, throughout the software development process. It happens everywhere all the time, so that's where a tester needs to be. 
...
Does any of this make sense? How dynamic is your role, both across software developent and the three axes? How often do you talk about that with your team members or your manager? What is it that you dream of?
