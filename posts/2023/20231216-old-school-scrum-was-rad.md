...
For the last one, thee question about impediments,

> [...], the Scrum Master should encourage them to think "outside the box." If this were the perfect work environment, what else would it have? More specifically, what could help the team be more productive, both as a group of individuals and a cohesive team? *(p 44)*
