...
Testing types in software testing are a mess. It's not just ["regression testing"](link://slug/regression-testing-it-means-less-than-you-think) that can mean more things than there are people in the room. It's true for basically all of them.
...
Or if you take it to extremes: dynamic functional whitebox regression mobile UI exploratory pair testing.
...
"Developer testing" is done by developers, but are they in an outsourced development team or in an agile one? When you say "automated testing", do you mean the automation of manual test scripts, or the tests that run in your pipeline? And there's also at least one testing type that makes it very clear what kind of software development it expects: "agile testing".
...
Which is how we get to Wittgenstein's philosophy of language:
