...
BLOG_AUTHOR = "Joep Schuurkes"  # (translatable)
BLOG_TITLE = "Joep Schuurkes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://smallsheds.garden/"
...
REDIRECTIONS = [
    ...
    ("fourhourtester/", "https://fourhourtester.smallsheds.garden")
]
...
# could add 'markdown.extensions.smarty' to have -- become an ndash; mdash is too much
#   single/double quote substitution seems to happen without smartpants
